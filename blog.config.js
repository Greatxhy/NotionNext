...
const BLOG = {
  ...
  NOTION_PAGE_ID: // 重要变量，使用vercal托管时需要填写
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '我是一个瞠目对日的学生, 我是一个拥抱春风的少年, 我是一个侃侃而谈的梦想家, 欢迎来到我的小屋做客🎉',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个平凡的干饭少年🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'great_xhy@163.com', // 邮箱地址 例如mail@tangly1024.com
